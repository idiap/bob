...
void bind_measure_error() {
  ...
  def("correctly_classified_positives", &bob::measure::correctlyClassifiedPositives, (arg("positives"), arg("threshold")),
  ...
  def("correctly_classified_negatives", &bob::measure::correctlyClassifiedNegatives, (arg("negatives"), arg("threshold")),
  ...
  def("eer_threshold", &bob::measure::eerThreshold, (arg("negatives"), arg("positives")),
  ...
  def("min_weighted_error_rate_threshold", &bob::measure::minWeightedErrorRateThreshold, (arg("negatives"), arg("positives"), arg("cost")),
  ...
  def("min_hter_threshold", &bob::measure::minHterThreshold, (arg("negatives"), arg("positives")),
      "Calculates the min_weighted_error_rate_threshold() when the cost is 0.5.");

  def("roc", &bob::measure::roc, (arg("negatives"), arg("positives"), arg("points")),
  ...
  def("ppndf", &bob::measure::ppndf, (arg("value")),
