...
void bind_ip_wgaussian() {
  static const char* wgaussiandoc = "This class performs weighted gaussian smoothing (anisotropic filtering). In particular, it is used by the Self Quotient Image (SQI) algorithm.";
	...
	class_<bob::ip::WeightedGaussian, boost::shared_ptr<bob::ip::WeightedGaussian> >("WeightedGaussian", wgaussiandoc, init<optional<const int, const int, const double, const double, const enum bob::sp::Extrapolation::BorderType> >((arg("radius_y")=1, arg("radius_x")=1, arg("sigma_y")=2., arg("sigma_x")=2., arg("conv_border")=bob::sp::Extrapolation::Mirror), "Creates a weighted gaussian smoother."))
      ...
      .def(self == self)
      .def(self != self)
      .add_property("radius_y", &bob::ip::WeightedGaussian::getRadiusY, &bob::ip::WeightedGaussian::setRadiusY, "The radius of the unweighted Gaussian along the y-axis (size of the kernel=2*radius+1)")
      .add_property("radius_x", &bob::ip::WeightedGaussian::getRadiusX, &bob::ip::WeightedGaussian::setRadiusX, "The radius of the unweighted Gaussian along the x-axis (size of the kernel=2*radius+1)")
      .add_property("sigma_y", &bob::ip::WeightedGaussian::getSigmaY, &bob::ip::WeightedGaussian::setSigmaY, "The variance of the unweighted Gaussian along the y-axis")
      .add_property("sigma_x", &bob::ip::WeightedGaussian::getSigmaX, &bob::ip::WeightedGaussian::setSigmaX, "The variance of the unweighted Gaussian along the x-axis")
      ...
      .def("reset", &bob::ip::WeightedGaussian::reset, (arg("self"), arg("radius_y")=1, arg("radius_x")=1, arg("sigma_y")=5., arg("sigma_x")=5., arg("conv_border")=bob::sp::Extrapolation::Mirror), "Resets the parametrization of the Weighted Gaussian")
