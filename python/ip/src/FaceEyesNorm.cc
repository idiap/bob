...
void bind_ip_faceeyesnorm() {
  class_<ip::FaceEyesNorm, boost::shared_ptr<ip::FaceEyesNorm> >("FaceEyesNorm", faceeyesnorm_doc, init<const int, const int, const int, const int, const int>((arg("eyes_distance"), arg("crop_height"), arg("crop_width"), arg("crop_eyecenter_offset_h"), arg("crop_eyecenter_offset_w")), "Constructs a FaceEyeNorm object."))
    ...
    .def("__call__", &call1, (arg("input"), arg("output"), arg("le_y"), arg("le_x"), arg("re_y"), arg("re_x")), "Call an object of this type to extract a face given the coordinates of the left (le_y, le_x) and right (re_y, re_x) eye centers. Please note that the horizontal position le_x of the left eye is usually larger than the positon re_x of the right eye.") 
    .def("__call__", &call2, (arg("input"), arg("input_mask"), arg("output"), arg("output_mask"), arg("le_y"), arg("le_x"), arg("re_y"), arg("re_x")), "Call an object of this type to extract a face given the coordinates of the left (le_y, le_x) and right (re_y, re_x) eye centers, taking mask into account.")
    ;
}
