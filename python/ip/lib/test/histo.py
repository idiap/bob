...
class HistogramTest(unittest.TestCase):
  ...
  def test01_uint8_histoPython(self):
    ...
    histo_ref = bob.io.load(os.path.join('histo','image_histo.hdf5'))
  ...
  def test02_uint16_histoPython(self):
    ...
    input_array = bob.io.load(os.path.join('histo','input_uint16.hdf5'))
    ...
    histo_ref = bob.io.load(os.path.join('histo','input_uint16.histo.hdf5'))
  ...
  def test03_float_histoPython(self):
    ...
    input_array = bob.io.load(os.path.join('histo','input_float.hdf5'))
    ...
    histo_ref = bob.io.load(os.path.join('histo','input_float.histo.hdf5'))
  ...
  def test04_int32_histoPython(self):
    ...
    input_array = bob.io.load(os.path.join('histo','input_int32.hdf5'))
    ...
    histo_ref = bob.io.load(os.path.join('histo','input_int32.histo.hdf5'))
...
main = bob.helper.unittest_main(HistogramTest)
