...
class ScriptTest (unittest.TestCase):
  ...
  @utils.ffmpeg_found()
  def test_face_detect_on_movie(self):
  ...
  @utils.visioner_available
  def test_face_detect_on_image(self):
  ...
  @utils.visioner_available
  @utils.ffmpeg_found()
  def test_keypoint_localization_on_movie(self):
  ...
  @utils.visioner_available
  def test_keypoint_localization_on_image(self):
