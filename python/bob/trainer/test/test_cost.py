...
class CostTest (unittest.TestCase):
  ...
  def test_square_error_derivative(self):
  ...
  def test_square_error_error(self):
  ...
  def test_square_error_equality(self):
  ...
  def test_cross_entropy_equality(self):
  ...
  def test_cross_entropy_error_with_logistic(self):
  ...
  def test_cross_entropy_error_without_logistic(self):
  ...
  def test_cross_entropy_activation_detection(self):
