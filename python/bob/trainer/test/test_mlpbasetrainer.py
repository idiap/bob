...
class MLPTrainerTest (unittest.TestCase):

  def test_2in_1out_nobias(self):
  ...
  def test_2in_3_1out_nobias(self):
  ...
  def test_100in_10_10_5out_nobias(self):
  ...
  def test_machine_compatibility(self):
  ...
  def test_batch_size_setup(self):
