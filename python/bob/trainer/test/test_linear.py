...
class LinearTest (unittest.TestCase):
  ...
  def test_pca_versus_matlab_princomp(self):
  ...
  def test_pca_versus_matlab_princomp_2(self):
  ...
  def test_pca_trainer_comparisons(self):
  ...
  def test_pca_svd_vs_cov_random_1(self):
  ...
  def test_pca_svd_vs_cov_random_2(self):
  ...
  def test_fisher_lda_settings(self):
  ...
  def test_fisher_lda_comparisons(self):
  ...
  def test_whitening_initialization(self):
  ...
  def test_wccn_initialization(self):
