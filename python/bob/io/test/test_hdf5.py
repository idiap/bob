...
class HDF5Test (unittest.TestCase):
  ...
  def test_can_load_hdf5_from_matlab(self):
  ...
  def test_ioload_unlimited(self):
  ...
  def test_string_attribute_support(self):
  ...
  def test_can_use_set_with_iterables(self):
  ...
  def test_append_compression(self):
