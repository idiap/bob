...
version = bob.build.version
# The full version, including alpha/beta/rc tags.
release = bob.build.version
...
# of the sidebar.
html_logo = bob.build.source_file('doc/img/bob+reflection-sphinx.png')

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = bob.build.source_file('doc/img/favicon.ico')
...
latex_documents = [
  ('doc/index', 'bobman.tex', u'Bob',
   u'Biometrics Group, Idiap Research Institute', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = bob.build.source_file('doc/img/bob.pdf')
...
intersphinx_mapping = {
  'http://docs.python.org/%s/' % bob.build.python_version: None,
  numpy_manual: None,
  scipy_manual: None,
  sqlalc_manual: None,
