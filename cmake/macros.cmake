...
macro(bob_python_package cxx_package package cxx_src pydependencies)
  ...
  if(NOT TARGET egg)
    ...
    add_custom_target(egg ALL mkdir -pv ${CMAKE_BINARY_DIR}/${PYTHON_SITE_PACKAGES} COMMAND ${pybin} ${pysetup} build --force --build-base=files-build install --prefix=${CMAKE_BINARY_DIR} --single-version-externally-managed WORKING_DIRECTORY ${basedir} WORKING_DIRECTORY ${basedir})
  endif()
