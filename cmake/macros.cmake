...
macro(bob_python_package cxx_package package cxx_src pydependencies)
  ...
  if(NOT TARGET egg)
    ...
    set(pysetup "${CMAKE_BINARY_DIR}/egg/build/setup.py")
    get_filename_component(basedir ${pysetup} PATH)
    add_custom_target(egg ALL mkdir -pv ${CMAKE_BINARY_DIR}/${PYTHON_SITE_PACKAGES} COMMAND ${pybin} ${pysetup} build COMMAND ${pybin} ${pysetup} install --prefix=${CMAKE_BINARY_DIR} WORKING_DIRECTORY ${basedir} WORKING_DIRECTORY ${basedir})
  endif()
