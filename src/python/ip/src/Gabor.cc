...
void bind_ip_gabor() {
  ...
  class_<ip::GaborBankFrequency, boost::shared_ptr<ip::GaborBankFrequency> >("GaborBankFrequency", gabor_bank_frequency_doc, init<const int, const int, optional<const int, const int, const double, const bool, const double, const double, const double, const double, const double, const bool, const bool, const bool> >((arg("height"), arg("width"), arg("n_orient"), arg("n_freq"), arg("fmax")="0.25", arg("orientation_full")="false", arg("k")="1.414", arg("p")="0.5", arg("gamma")="1.", arg("eta")="1.", arg("pf")="0.99", arg("cancel_dc")="false", arg("use_envelope")="false", arg("output_in_frequency")="false"), "Constructs a new Gabor filter in the frequency domain."))
    //.add_property("test", &ip::TanTriggs::getTest, &ip::TanTriggs::setTest)
