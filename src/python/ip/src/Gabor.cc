...
void bind_ip_gabor() {
  ...
  class_<ip::GaborSpatial, boost::shared_ptr<ip::GaborSpatial> >("GaborSpatial", gabor_spatial_doc, init<optional<const double, const double, const double, const double, const int, const bool, const enum bob::ip::Gabor::NormOption, const enum bob::sp::Extrapolation::BorderType> >((arg("f")=0.25, arg("theta")=0., arg("gamma")=1., arg("eta")=1., arg("spatial_size")=35, arg("cancel_dc")=false, arg("norm")=ip::Gabor::SpatialFactor, arg("border_type")=bob::sp::Extrapolation::Mirror), "Constructs a new Gabor filter in the spatial domain."))
    ...
    .add_property("border_type", &ip::GaborSpatial::getBorderType, &ip::GaborSpatial::setBorderType)
  ...
  class_<ip::GaborBankSpatial, boost::shared_ptr<ip::GaborBankSpatial> >("GaborBankSpatial", gabor_bank_spatial_doc, init<optional<const int, const int, const double, const bool, const double, const double, const double, const double, const int, const bool, const enum bob::ip::Gabor::NormOption, const enum bob::sp::Extrapolation::BorderType> >((arg("n_orient"), arg("n_freq"), arg("fmax")=0.25, arg("orientation_full")=false, arg("k")=1.414, arg("p")=0.5, arg("gamma")=1., arg("eta")=1., arg("spatial_size")=35, arg("cancel_dc")=false, arg("norm")=ip::Gabor::SpatialFactor, arg("border_type")=bob::sp::Extrapolation::Mirror), "Constructs a new Gabor filter bank in the spatial domain."))
    ...
    .add_property("border_type", &ip::GaborBankSpatial::getBorderType, &ip::GaborBankSpatial::setBorderType)
