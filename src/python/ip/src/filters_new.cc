...
static const char* ZIGZAG_DOC = "Extract elements in a zigzag manner from a 2D blitz array and stores them in a 1D blitz array.";
...
#define FILTER_DEF(T,N) \
  ...
  def("zigzag", (void (*)(const blitz::Array<T,2>&, blitz::Array<T,1>&, int, const bool))&Torch::ip::zigzag<T>, zigzag_overloads_ ## N ((arg("src"), arg("dst"), arg("n_dct_kept")="-1", arg("zigzag_order")="False"), ZIGZAG_DOC));
