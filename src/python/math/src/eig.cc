...
void bind_math_eig()
{
  ...
  def("eig", (void (*)(const blitz::Array<double,2>& A, const blitz::Array<double,2>& B, blitz::Array<double,2>& V, blitz::Array<double,1>& D))&Torch::math::eig, (arg("A"),arg("B"),arg("V"),arg("D")), EIGSYMGEN_DOC);
}
