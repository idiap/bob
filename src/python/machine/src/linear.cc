...
void bind_machine_linear() {
  class_<mach::LinearMachine, boost::shared_ptr<mach::LinearMachine>
    ...
    .def("setWeightsAndBiases", &mach::LinearMachine::setWeightsAndBiases,
        (arg("self"), arg("weights"), arg("biases")), "Sets the weights and biases of the current machine, checking dimensions so they are compatible with each other.")
