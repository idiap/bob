...
void bind_machine_mlp() {
  ...
  //so we can return std::vector<blitz::Array<double,N> > transparently
  Torch::python::vector_no_compare<blitz::Array<double,1> >("array_double_1_vector");
  Torch::python::vector_no_compare<blitz::Array<double,2> >("array_double_2_vector");
