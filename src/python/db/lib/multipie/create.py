...
def add_protocols(session):
  ...
  def addProtocolMultiview(session, protocol, group, purpose, session_id, recording_id, camera_id, shot_id):
    ...
    p = Protocol(protocol, group, purpose, session_id, recording_id)
    session.add(p)
    session.flush()
    session.refresh(p)
  ...
  # TODO: full protocol
  session.add(ProtocolName('Mc'))

  #session.add(ProtocolHighres('Mc', 'world', 'world', 1, 1))
  #session.add(ProtocolHighres('Mc', 'world', 'world', 1, 2))
  addProtocolMultiview(session, 'Mc', 'world', 'world', 1, 1, '05_1', 0)
  addProtocolMultiview(session, 'Mc', 'world', 'world', 1, 1, '05_1', 19)
  addProtocolMultiview(session, 'Mc', 'world', 'world', 2, 1, '05_1', 0)
  addProtocolMultiview(session, 'Mc', 'world', 'world', 2, 1, '05_1', 19)
  addProtocolMultiview(session, 'Mc', 'world', 'world', 3, 1, '05_1', 0)
  addProtocolMultiview(session, 'Mc', 'world', 'world', 3, 1, '05_1', 19)
  addProtocolMultiview(session, 'Mc', 'world', 'world', 4, 1, '05_1', 0)
  addProtocolMultiview(session, 'Mc', 'world', 'world', 4, 1, '05_1', 19)
  addProtocolMultiview(session, 'Mc', 'world', 'world', 4, 2, '05_1', 0)
  addProtocolMultiview(session, 'Mc', 'world', 'world', 4, 2, '05_1', 19)

  addProtocolMultiview(session, 'Mc', 'dev', 'enrol', 1, 1, '05_1', 0)
  addProtocolMultiview(session, 'Mc', 'dev', 'enrol', 1, 1, '05_1', 19)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 1)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 2)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 3)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 4)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 5)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 6)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 7)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 8)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 9)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 10)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 11)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 12)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 13)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 14)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 15)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 16)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 17)
  addProtocolMultiview(session, 'Mc', 'dev', 'probe', 1, 1, '05_1', 18)
  #session.add(ProtocolHighres('Mc', 'dev', 'enrol', 1, 1))
  #session.add(ProtocolHighres('Mc', 'dev', 'enrol', 1, 2))

  session.add(ProtocolProbeImpostorId('Mc', 5, 6, 'dev'))
  session.add(ProtocolProbeImpostorId('Mc', 6, 5, 'dev'))
...
def create_tables(args):
  ...
  #ProtocolHighres.metadata.create_all(engine)
