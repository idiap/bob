...
class ArraysetCodecTest(unittest.TestCase):
  ...
  def test03_Transcoding(self):
    ...
    binary = torch.database.ArraysetCodecRegistry.getCodecByName("hdf5.arrayset.binary")
  ...
  def test04_Deregistration(self):
    ...
    # static method.
    torch.database.ArraysetCodecRegistry.removeCodecByName("example.arrayset.text")
