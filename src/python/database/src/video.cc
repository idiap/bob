...
void bind_database_video() {
  ...
  class_<db::VideoReader, boost::shared_ptr<db::VideoReader> >("VideoReader",
    ...
    .add_property("filename", make_function(&db::VideoReader::filename, return_internal_reference<>()))
    ...
    .add_property("codecName", make_function(&db::VideoReader::codecName, return_internal_reference<>()))
    .add_property("codecLongName", make_function(&db::VideoReader::codecLongName, return_internal_reference<>()))
    .add_property("frameRate", &db::VideoWriter::frameRate)
    .add_property("info", make_function(&db::VideoReader::info, return_internal_reference<>()))
  ...
  class_<db::VideoWriter, boost::shared_ptr<db::VideoWriter> >("VideoWriter",
    ...
    .add_property("filename", make_function(&db::VideoWriter::filename, return_internal_reference<>()))
