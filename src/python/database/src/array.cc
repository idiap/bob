...
void bind_database_array() {
  ...
  class_<db::Array, boost::shared_ptr<db::Array> >("Array", "Dataset Arrays represent pointers to concrete data serialized on a database. You can load or refer to real blitz::Arrays using this type.", init<const std::string&, optional<const std::string&> >((arg("filename"),arg("codecname")=""), "Initializes a new array from an external file. An optional codec may be passed."))
    ...
    ARRAY_ALL_DEF(bool, bool, 1)
    ARRAY_ALL_DEF(int8_t, int8, 1)
    ARRAY_ALL_DEF(int16_t, int16, 1)
    ARRAY_ALL_DEF(int32_t, int32, 1)
    ARRAY_ALL_DEF(int64_t, int64, 1)
    ARRAY_ALL_DEF(uint8_t, uint8, 1)
    ARRAY_ALL_DEF(uint16_t, uint16, 1)
    ARRAY_ALL_DEF(uint32_t, uint32, 1)
    ARRAY_ALL_DEF(uint64_t, uint64, 1)
    ARRAY_ALL_DEF(float, float32, 1)
    ARRAY_ALL_DEF(double, float64, 1)
    ARRAY_ALL_DEF(double, float128, 1)
    ARRAY_ALL_DEF(std::complex<float>, complex64, 1)
    ARRAY_ALL_DEF(std::complex<double>, complex128, 1)
    ARRAY_ALL_DEF(std::complex<double>, complex256, 1)
    ARRAY_ALL_DEF(bool, bool, 2)
    ARRAY_ALL_DEF(int8_t, int8, 2)
    ARRAY_ALL_DEF(int16_t, int16, 2)
    ARRAY_ALL_DEF(int32_t, int32, 2)
    ARRAY_ALL_DEF(int64_t, int64, 2)
    ARRAY_ALL_DEF(uint8_t, uint8, 2)
    ARRAY_ALL_DEF(uint16_t, uint16, 2)
    ARRAY_ALL_DEF(uint32_t, uint32, 2)
    ARRAY_ALL_DEF(uint64_t, uint64, 2)
    ARRAY_ALL_DEF(float, float32, 2)
    ARRAY_ALL_DEF(double, float64, 2)
    ARRAY_ALL_DEF(double, float128, 2)
    ARRAY_ALL_DEF(std::complex<float>, complex64, 2)
    ARRAY_ALL_DEF(std::complex<double>, complex128, 2)
    ARRAY_ALL_DEF(std::complex<double>, complex256, 2)
    ARRAY_ALL_DEF(bool, bool, 3)
    ARRAY_ALL_DEF(int8_t, int8, 3)
    ARRAY_ALL_DEF(int16_t, int16, 3)
    ARRAY_ALL_DEF(int32_t, int32, 3)
    ARRAY_ALL_DEF(int64_t, int64, 3)
    ARRAY_ALL_DEF(uint8_t, uint8, 3)
    ARRAY_ALL_DEF(uint16_t, uint16, 3)
    ARRAY_ALL_DEF(uint32_t, uint32, 3)
    ARRAY_ALL_DEF(uint64_t, uint64, 3)
    ARRAY_ALL_DEF(float, float32, 3)
    ARRAY_ALL_DEF(double, float64, 3)
    ARRAY_ALL_DEF(double, float128, 3)
    ARRAY_ALL_DEF(std::complex<float>, complex64, 3)
    ARRAY_ALL_DEF(std::complex<double>, complex128, 3)
    ARRAY_ALL_DEF(std::complex<double>, complex256, 3)
    ARRAY_ALL_DEF(bool, bool, 4)
    ARRAY_ALL_DEF(int8_t, int8, 4)
    ARRAY_ALL_DEF(int16_t, int16, 4)
    ARRAY_ALL_DEF(int32_t, int32, 4)
    ARRAY_ALL_DEF(int64_t, int64, 4)
    ARRAY_ALL_DEF(uint8_t, uint8, 4)
    ARRAY_ALL_DEF(uint16_t, uint16, 4)
    ARRAY_ALL_DEF(uint32_t, uint32, 4)
    ARRAY_ALL_DEF(uint64_t, uint64, 4)
    ARRAY_ALL_DEF(float, float32, 4)
    ARRAY_ALL_DEF(double, float64, 4)
    ARRAY_ALL_DEF(double, float128, 4)
    ARRAY_ALL_DEF(std::complex<float>, complex64, 4)
    ARRAY_ALL_DEF(std::complex<double>, complex128, 4)
    ARRAY_ALL_DEF(std::complex<double>, complex256, 4)
    ;
}
