...
#define CONVOLVE_DEF(T,N) \
  ...
  def("convolveSep", (void (*)(const blitz::Array<T,3>&, const blitz::Array<T,1>&, blitz::Array<T,3>&, const int, const enum Torch::sp::Convolution::SizeOption, const enum Torch::sp::Convolution::BorderOption))&Torch::sp::convolveSep<T>, convolveSep_overloads_ ## N ((arg("b"), arg("c"), arg("a"), arg("dim"), arg("size_opt")="Full", arg("border_opt")="Zero"), CONVOLVE_DOC)); \
  def("convolveSep", (void (*)(const blitz::Array<T,4>&, const blitz::Array<T,1>&, blitz::Array<T,4>&, const int, const enum Torch::sp::Convolution::SizeOption, const enum Torch::sp::Convolution::BorderOption))&Torch::sp::convolveSep<T>, convolveSep_overloads_ ## N ((arg("b"), arg("c"), arg("a"), arg("dim"), arg("size_opt")="Full", arg("border_opt")="Zero"), CONVOLVE_DOC));
