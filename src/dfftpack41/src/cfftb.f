C     _SUBROUTINE CFFTB(N,C,WSAVE)
C
C     _SUBROUTINE CFFTB COMPUTES THE BACKWARD COMPLEX DISCRETE FOURIER
...
C     SEQUENCE BY N.
C
C     THE ARRAY WSAVE WHICH IS USED BY _SUBROUTINE CFFTB MUST BE
C     INITIALIZED BY CALLING _SUBROUTINE CFFTI(N,WSAVE).
C
C     INPUT PARAMETERS
C
C
...
C             IN THE _PROGRAM THAT CALLS CFFTB. THE WSAVE ARRAY MUST BE
C             INITIALIZED BY CALLING _SUBROUTINE CFFTI(N,WSAVE) AND A
...
C             DESTROYED BETWEEN CALLS OF _SUBROUTINE CFFTF OR CFFTB
C
