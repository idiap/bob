C     _SUBROUTINE RFFTB(N,R,WSAVE)
C
C     _SUBROUTINE RFFTB COMPUTES THE REAL PERODIC SEQUENCE FROM ITS
...
C             IN THE _PROGRAM THAT CALLS RFFTB. THE WSAVE ARRAY MUST
C             BE INITIALIZED BY CALLING _SUBROUTINE RFFTI(N,WSAVE) AND
