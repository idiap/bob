C     _SUBROUTINE SINTI(N,WSAVE)
C
C     _SUBROUTINE SINTI INITIALIZES THE ARRAY WSAVE WHICH IS USED IN
C     _SUBROUTINE SINT. THE PRIME FACTORIZATION OF N TOGETHER WITH
