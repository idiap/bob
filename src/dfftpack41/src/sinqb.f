C     _SUBROUTINE SINQB(N,X,WSAVE)
C
C     _SUBROUTINE SINQB COMPUTES THE FAST FOURIER TRANSFORM OF QUARTER
...
C     BY 4*N.
C
C     THE ARRAY WSAVE WHICH IS USED BY _SUBROUTINE SINQB MUST BE
...
C             IN THE _PROGRAM THAT CALLS SINQB. THE WSAVE ARRAY MUST
