C     _SUBROUTINE CFFTF(N,C,WSAVE)
C
C     _SUBROUTINE CFFTF COMPUTES THE FORWARD COMPLEX DISCRETE FOURIER
...
C
C     THE ARRAY WSAVE WHICH IS USED BY _SUBROUTINE CFFTF MUST BE
...
C             IN THE _PROGRAM THAT CALLS CFFTF. THE WSAVE ARRAY MUST BE
