...
\
      ...
      TENSOR1##_p += TENSOR1->stride[TH_TENSOR_DIM_APPLY_i]; \
      TENSOR2##_p += TENSOR2->stride[TH_TENSOR_DIM_APPLY_i]; \
      TENSOR3##_p += TENSOR3->stride[TH_TENSOR_DIM_APPLY_i]; \
\
      ...
      { \
        ...
        { \
          TENSOR1##_p -= TH_TENSOR_DIM_APPLY_counter[TH_TENSOR_DIM_APPLY_i]*TENSOR1->stride[TH_TENSOR_DIM_APPLY_i]; \
          TENSOR2##_p -= TH_TENSOR_DIM_APPLY_counter[TH_TENSOR_DIM_APPLY_i]*TENSOR2->stride[TH_TENSOR_DIM_APPLY_i]; \
          TENSOR3##_p -= TH_TENSOR_DIM_APPLY_counter[TH_TENSOR_DIM_APPLY_i]*TENSOR3->stride[TH_TENSOR_DIM_APPLY_i]; \
          TH_TENSOR_DIM_APPLY_counter[TH_TENSOR_DIM_APPLY_i] = 0; \
        } \
      } \
      else \
...
\
      TH_TENSOR_DIM_APPLY_counter[TH_TENSOR_DIM_APPLY_i]++; \
      TENSOR##_p += TENSOR->stride[TH_TENSOR_DIM_APPLY_i]; \
\
      ...
      { \
        ...
        { \
          TENSOR##_p -= TH_TENSOR_DIM_APPLY_counter[TH_TENSOR_DIM_APPLY_i]*TENSOR->stride[TH_TENSOR_DIM_APPLY_i]; \
          TH_TENSOR_DIM_APPLY_counter[TH_TENSOR_DIM_APPLY_i] = 0; \
        } \
      } \
      else \
