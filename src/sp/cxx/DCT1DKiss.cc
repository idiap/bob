...
bob::sp::DCT1DKissAbstract::DCT1DKissAbstract(const size_t length):
  m_length(length),
...
bob::sp::DCT1DKissAbstract::DCT1DKissAbstract(
    const bob::sp::DCT1DKissAbstract& other):
...
bob::sp::DCT1DKissAbstract& 
bob::sp::DCT1DKissAbstract::operator=(const DCT1DKissAbstract& other)
{
  if (this != &other) {
    m_length = other.m_length;
...
bool bob::sp::DCT1DKissAbstract::operator==(const bob::sp::DCT1DKissAbstract& b) const
{
...
void bob::sp::DCT1DKissAbstract::operator()(const blitz::Array<double,1>& src, 
...
void bob::sp::DCT1DKissAbstract::setLength(const size_t length)
{
  m_length = length;
...
void bob::sp::DCT1DKissAbstract::initNormFactors()
{
...
bob::sp::DCT1DKiss::DCT1DKiss(const size_t length):
  bob::sp::DCT1DKissAbstract(length),
  m_fft(2*length),
  m_buffer_1(2*length),
  m_buffer_2(2*length)
{
...
bob::sp::DCT1DKiss::DCT1DKiss(const bob::sp::DCT1DKiss& other):
  bob::sp::DCT1DKissAbstract(other),
...
bob::sp::DCT1DKiss::~DCT1DKiss()
{
}

bob::sp::DCT1DKiss& 
bob::sp::DCT1DKiss::operator=(const DCT1DKiss& other)
{
  if (this != &other) {
    bob::sp::DCT1DKissAbstract::operator=(other);
...
void bob::sp::DCT1DKiss::setLength(const size_t length)
{
  bob::sp::DCT1DKissAbstract::setLength(length);
  m_fft.setLength(2*m_length);
  m_buffer_1.resize(2*length);
  m_buffer_2.resize(2*length);
}
  
void bob::sp::DCT1DKiss::processNoCheck(const blitz::Array<double,1>& src, 
  blitz::Array<double,1>& dst) const
{
...
void bob::sp::DCT1DKiss::initWorkingArray()
{
...
bob::sp::IDCT1DKiss::IDCT1DKiss(const size_t length):
  bob::sp::DCT1DKissAbstract(length),
  m_ifft(length),
  m_buffer_1(length),
  m_buffer_2(length)
...
bob::sp::IDCT1DKiss::IDCT1DKiss(const bob::sp::IDCT1DKiss& other):
  bob::sp::DCT1DKissAbstract(other),
...
bob::sp::IDCT1DKiss::~IDCT1DKiss()
{
}

bob::sp::IDCT1DKiss& 
bob::sp::IDCT1DKiss::operator=(const IDCT1DKiss& other)
{
  if (this != &other) {
    bob::sp::DCT1DKissAbstract::operator=(other);
...
void bob::sp::IDCT1DKiss::setLength(const size_t length)
{
  bob::sp::DCT1DKissAbstract::setLength(length);
...
void bob::sp::IDCT1DKiss::processNoCheck(const blitz::Array<double,1>& src, 
  blitz::Array<double,1>& dst) const
{
  // Compute the DCT
...
void bob::sp::IDCT1DKiss::initWorkingArray()
{
  std::complex<double> J(0., 1.);
  const double PI = boost::math::constants::pi<double>();
  std::complex<double> factor = J*PI / (double)(2*m_length);
