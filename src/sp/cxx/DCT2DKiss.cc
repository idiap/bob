...
bob::sp::DCT2DKissAbstract::DCT2DKissAbstract(
...
bob::sp::DCT2DKissAbstract::DCT2DKissAbstract(
    const bob::sp::DCT2DKissAbstract& other):
...
bob::sp::DCT2DKissAbstract& 
bob::sp::DCT2DKissAbstract::operator=(const DCT2DKissAbstract& other)
{
  if (this != &other) {
...
bool bob::sp::DCT2DKissAbstract::operator==(const bob::sp::DCT2DKissAbstract& b) const
{
...
void bob::sp::DCT2DKissAbstract::operator()(const blitz::Array<double,2>& src, 
...
void bob::sp::DCT2DKissAbstract::setHeight(const size_t height)
{
  m_height = height;
...
void bob::sp::DCT2DKissAbstract::setWidth(const size_t width)
{
  m_width = width;
  m_buffer_hw.resize(m_height, m_width);
  m_buffer_h.resize(m_height);
...
bob::sp::DCT2DKiss::DCT2DKiss(const size_t height, const size_t width):
  bob::sp::DCT2DKissAbstract::DCT2DKissAbstract(height, width),
  m_dct_h(height),
  m_dct_w(width)
{
}

bob::sp::DCT2DKiss::DCT2DKiss(const bob::sp::DCT2DKiss& other):
  bob::sp::DCT2DKissAbstract(other),
  m_dct_h(other.m_height),
  m_dct_w(other.m_width)
{
}

bob::sp::DCT2DKiss::~DCT2DKiss()
{
}

bob::sp::DCT2DKiss& 
bob::sp::DCT2DKiss::operator=(const DCT2DKiss& other)
{
  if (this != &other) {
    bob::sp::DCT2DKissAbstract::operator=(other);
...
void bob::sp::DCT2DKiss::setHeight(const size_t height)
{
  bob::sp::DCT2DKissAbstract::setHeight(height);
  m_dct_h.setLength(height);
}

void bob::sp::DCT2DKiss::setWidth(const size_t width)
{
  bob::sp::DCT2DKissAbstract::setWidth(width);
  m_dct_w.setLength(width);
}
 
void bob::sp::DCT2DKiss::processNoCheck(const blitz::Array<double,2>& src, 
  blitz::Array<double,2>& dst) const
{
...
bob::sp::IDCT2DKiss::IDCT2DKiss(const size_t height, const size_t width):
  bob::sp::DCT2DKissAbstract::DCT2DKissAbstract(height, width),
  m_idct_h(height),
  m_idct_w(width)
{
...
bob::sp::IDCT2DKiss::IDCT2DKiss(const bob::sp::IDCT2DKiss& other):
  bob::sp::DCT2DKissAbstract(other),
...
bob::sp::IDCT2DKiss::~IDCT2DKiss()
{
}

bob::sp::IDCT2DKiss& 
bob::sp::IDCT2DKiss::operator=(const IDCT2DKiss& other)
{
  if (this != &other) {
    bob::sp::DCT2DKissAbstract::operator=(other);
...
void bob::sp::IDCT2DKiss::setHeight(const size_t height)
{
  bob::sp::DCT2DKissAbstract::setHeight(height);
  m_idct_h.setLength(height);
}

void bob::sp::IDCT2DKiss::setWidth(const size_t width)
{
  bob::sp::DCT2DKissAbstract::setWidth(width);
  m_idct_w.setLength(width);
}

void bob::sp::IDCT2DKiss::processNoCheck(const blitz::Array<double,2>& src, 
  blitz::Array<double,2>& dst) const
{
  blitz::Range rall = blitz::Range::all();
  // Compute the DCT
