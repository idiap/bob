...
static const char* FFT1DNumpy_DOC = "Objects of this class, after configuration, can compute the direct FFT of a 1D array/signal.";
...
static object py_fft1d_p(bob::sp::FFT1DNumpy& op, bob::python::const_ndarray src)
{
...
static object py_ifft1d_p(bob::sp::IFFT1DNumpy& op, bob::python::const_ndarray src)
{
  bob::python::ndarray dst(bob::core::array::t_complex128, op.getLength());
  blitz::Array<std::complex<double>,1> dst_ = dst.bz<std::complex<double>,1>();
  op(src.bz<std::complex<double>,1>(), dst_);
...
static object script_fft(bob::python::const_ndarray ar) 
{
  ...
  switch (info.nd) {
    case 1:
      {
        bob::sp::FFT1DNumpy op(info.shape[0]);
    ...
    case 2:
      {
        bob::sp::FFT2DNumpy op(info.shape[0], info.shape[1]);
...
static object script_ifft(bob::python::const_ndarray ar) 
{
  ...
  switch (info.nd) {
    case 1:
      {
        bob::sp::IFFT1DNumpy op(info.shape[0]);
        blitz::Array<dcplx,1> res_ = res.bz<dcplx,1>();
        op(ar.bz<dcplx,1>(), res_);
      }
      break;
    case 2:
      {
        bob::sp::IFFT2DNumpy op(info.shape[0], info.shape[1]);
        blitz::Array<dcplx,2> res_ = res.bz<dcplx,2>();
        op(ar.bz<dcplx,2>(), res_);
      }
      break;
...
void bind_sp_fft_numpy()
{
  ...
  class_<bob::sp::FFT1DNumpyAbstract, boost::noncopyable>("FFT1DNumpyAbstract", "Abstract class for FFT1DNumpy", no_init)
    .add_property("length", &bob::sp::FFT1DNumpy::getLength, &bob::sp::FFT1DNumpy::setLength)
    ;

  class_<bob::sp::FFT1DNumpy, boost::shared_ptr<bob::sp::FFT1DNumpy>, bases<bob::sp::FFT1DNumpyAbstract> >("FFT1DNumpy", FFT1DNumpy_DOC, init<const size_t>((arg("self"), arg("length"))))
      .def(init<bob::sp::FFT1DNumpy&>((arg("self"), arg("other"))))
      .def(self == self)
      .def(self != self)
  ...
  class_<bob::sp::IFFT1DNumpy, boost::shared_ptr<bob::sp::IFFT1DNumpy>, bases<bob::sp::FFT1DNumpyAbstract> >("IFFT1DNumpy", IFFT1DNumpy_DOC, init<const size_t>((arg("self"), arg("length"))))
      .def(init<bob::sp::IFFT1DNumpy&>((arg("self"), arg("other"))))
      .def(self == self)
      .def(self != self)
  ...
  class_<bob::sp::FFT2DNumpyAbstract, boost::noncopyable>("FFT2DNumpyAbstract", "Abstract class for FFT2DNumpy", no_init)
    .add_property("height", &bob::sp::FFT2DNumpy::getHeight, &bob::sp::FFT2DNumpy::setHeight)
    .add_property("width", &bob::sp::FFT2DNumpy::getWidth, &bob::sp::FFT2DNumpy::setWidth)
    ;

  class_<bob::sp::FFT2DNumpy, boost::shared_ptr<bob::sp::FFT2DNumpy>, bases<bob::sp::FFT2DNumpyAbstract> >("FFT2DNumpy", FFT2DNumpy_DOC, init<const size_t,const size_t>((arg("self"), arg("height"), arg("width"))))
      .def(init<bob::sp::FFT2DNumpy&>((arg("self"), arg("other"))))
      .def(self == self)
      .def(self != self)
  ...
  class_<bob::sp::IFFT2DNumpy, boost::shared_ptr<bob::sp::IFFT2DNumpy>, bases<bob::sp::FFT2DNumpyAbstract> >("IFFT2DNumpy", IFFT2DNumpy_DOC, init<const size_t,const size_t>((arg("self"), arg("height"), arg("width"))))
      .def(init<bob::sp::IFFT2DNumpy&>((arg("self"), arg("other"))))
      .def(self == self)
      .def(self != self)
