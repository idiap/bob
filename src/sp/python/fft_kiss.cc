...
static const char* FFT1DKiss_DOC = "Objects of this class, after configuration, can compute the direct FFT of a 1D array/signal.";
static const char* IFFT1DKiss_DOC = "Objects of this class, after configuration, can compute the inverse FFT of a 1D array/signal.";
static const char* FFT2DKiss_DOC = "Objects of this class, after configuration, can compute the direct FFT of a 2D array/signal.";
static const char* IFFT2DKiss_DOC = "Objects of this class, after configuration, can compute the inverse FFT of a 2D array/signal.";
...
static void py_fft1d_c(bob::sp::FFT1DKiss& op, bob::python::const_ndarray src,
...
static object py_fft1d_p(bob::sp::FFT1DKiss& op, bob::python::const_ndarray src)
{
...
static void py_ifft1d_c(bob::sp::IFFT1DKiss& op, bob::python::const_ndarray src,
  bob::python::ndarray dst) 
{
  blitz::Array<std::complex<double>,1> dst_ = dst.bz<std::complex<double>,1>();
  op(src.bz<std::complex<double>,1>(), dst_);
...
static object py_ifft1d_p(bob::sp::IFFT1DKiss& op, bob::python::const_ndarray src)
{
  bob::python::ndarray dst(bob::core::array::t_complex128, op.getLength());
  blitz::Array<std::complex<double>,1> dst_ = dst.bz<std::complex<double>,1>();
  op(src.bz<std::complex<double>,1>(), dst_);
...
static void py_fft2d_c(bob::sp::FFT2DKiss& op, bob::python::const_ndarray src,
  bob::python::ndarray dst) 
{
...
static object py_fft2d_p(bob::sp::FFT2DKiss& op, bob::python::const_ndarray src)
{
...
static void py_ifft2d_c(bob::sp::IFFT2DKiss& op, bob::python::const_ndarray src,
  bob::python::ndarray dst) 
{
  blitz::Array<std::complex<double>,2> dst_ = dst.bz<std::complex<double>,2>();
  op(src.bz<std::complex<double>,2>(), dst_);
...
static object py_ifft2d_p(bob::sp::IFFT2DKiss& op, bob::python::const_ndarray src)
{
  bob::python::ndarray dst(bob::core::array::t_complex128, op.getHeight(), 
    op.getWidth());
  blitz::Array<std::complex<double>,2> dst_ = dst.bz<std::complex<double>,2>();
...
static object script_fft(bob::python::const_ndarray ar) 
{
  ...
  switch (info.nd) {
    case 1:
      {
        bob::sp::FFT1DKiss op(info.shape[0]);
    ...
    case 2:
      {
        bob::sp::FFT2DKiss op(info.shape[0], info.shape[1]);
...
static object script_ifft(bob::python::const_ndarray ar) 
{
  ...
  switch (info.nd) {
    case 1:
      {
        bob::sp::IFFT1DKiss op(info.shape[0]);
        blitz::Array<dcplx,1> res_ = res.bz<dcplx,1>();
        op(ar.bz<dcplx,1>(), res_);
      }
      break;
    case 2:
      {
        bob::sp::IFFT2DKiss op(info.shape[0], info.shape[1]);
        blitz::Array<dcplx,2> res_ = res.bz<dcplx,2>();
        op(ar.bz<dcplx,2>(), res_);
      }
      break;
...
void bind_sp_fft_kiss()
{
  ...
  class_<bob::sp::FFT1DKissAbstract, boost::noncopyable>("FFT1DKissAbstract", "Abstract class for FFT1DKiss", no_init)
    .add_property("length", &bob::sp::FFT1DKiss::getLength, &bob::sp::FFT1DKiss::setLength)
    ;

  class_<bob::sp::FFT1DKiss, boost::shared_ptr<bob::sp::FFT1DKiss>, bases<bob::sp::FFT1DKissAbstract> >("FFT1DKiss", FFT1DKiss_DOC, init<const size_t>((arg("self"), arg("length"))))
      .def(init<bob::sp::FFT1DKiss&>((arg("self"), arg("other"))))
      .def(self == self)
      .def(self != self)
  ...
  class_<bob::sp::IFFT1DKiss, boost::shared_ptr<bob::sp::IFFT1DKiss>, bases<bob::sp::FFT1DKissAbstract> >("IFFT1DKiss", IFFT1DKiss_DOC, init<const size_t>((arg("self"), arg("length"))))
      .def(init<bob::sp::IFFT1DKiss&>((arg("self"), arg("other"))))
      .def(self == self)
      .def(self != self)
  ...
  class_<bob::sp::FFT2DKissAbstract, boost::noncopyable>("FFT2DKissAbstract", "Abstract class for FFT2DKiss", no_init)
    .add_property("height", &bob::sp::FFT2DKiss::getHeight, &bob::sp::FFT2DKiss::setHeight)
    .add_property("width", &bob::sp::FFT2DKiss::getWidth, &bob::sp::FFT2DKiss::setWidth)
    ;

  class_<bob::sp::FFT2DKiss, boost::shared_ptr<bob::sp::FFT2DKiss>, bases<bob::sp::FFT2DKissAbstract> >("FFT2DKiss", FFT2DKiss_DOC, init<const size_t,const size_t>((arg("self"), arg("height"), arg("width"))))
      .def(init<bob::sp::FFT2DKiss&>((arg("self"), arg("other"))))
      .def(self == self)
      .def(self != self)
  ...
  class_<bob::sp::IFFT2DKiss, boost::shared_ptr<bob::sp::IFFT2DKiss>, bases<bob::sp::FFT2DKissAbstract> >("IFFT2DKiss", IFFT2DKiss_DOC, init<const size_t,const size_t>((arg("self"), arg("height"), arg("width"))))
      .def(init<bob::sp::IFFT2DKiss&>((arg("self"), arg("other"))))
      .def(self == self)
      .def(self != self)
