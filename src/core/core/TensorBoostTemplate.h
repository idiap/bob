#ifndef TORCH5SPRO_TENSOR_BOOST_TEMPLATE_H
#define TORCH5SPRO_TENSOR_BOOST_TEMPLATE_H
...
//    Tensor(const Tensor &src);
      ...
      virtual void setTensor(const Tensor *src_) { Tensor::setTensor(src_); }
      /**
...
*/
    ...
    private:
      typedef typename boost::multi_array<T,1>                        Tensor_1D_Type;
      typedef typename boost::multi_array<T,2>                        Tensor_2D_Type;
      typedef typename boost::multi_array<T,3>                        Tensor_3D_Type;
      typedef typename boost::multi_array<T,4>                        Tensor_4D_Type;

      typedef typename boost::array_view_gen<Tensor_1D_Type,1>::type  View_1D_Type;
      typedef typename boost::array_view_gen<Tensor_2D_Type,2>::type  View_2D_Type;
      typedef typename boost::array_view_gen<Tensor_3D_Type,3>::type  View_3D_Type;
      typedef typename boost::array_view_gen<Tensor_4D_Type,4>::type  View_4D_Type;
      ...
      /** 
        ...
        */
      View_1D_Type*   getView1D()   const        { return m_view_1D; }
      View_2D_Type*   getView2D()   const        { return m_view_2D; }
      View_3D_Type*   getView3D()   const        { return m_view_3D; }
      View_4D_Type*   getView4D()   const        { return m_view_4D; }
      ...
      View_1D_Type    *m_view_1D;
      View_2D_Type    *m_view_2D;
      View_3D_Type    *m_view_3D;
      View_4D_Type    *m_view_4D;
