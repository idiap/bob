#ifndef TORCH5SPRO_TENSOR_BOOST_TEMPLATE_IMPL_H
#define TORCH5SPRO_TENSOR_BOOST_TEMPLATE_IMPL_H
...
*/
    ...
    m_data_RW(0)
  {
    initDimensionIndex();
    setDataType();
    m_array_1D = new Tensor_1D_Type(boost::extents[dim0]);
    ...
    m_data_RW(0)
  {
    initDimensionIndex();
    setDataType();
    m_array_2D = new Tensor_2D_Type(boost::extents[dim0][dim1]);
    ...
    m_data_RW(0)
  {
    initDimensionIndex();
    setDataType();
    m_array_3D = new Tensor_3D_Type(boost::extents[dim0][dim1][dim2]);
    ...
    m_data_RW(0)
  {
    initDimensionIndex();
    setDataType();
    m_array_4D = new Tensor_4D_Type(boost::extents[dim0][dim1][dim2][dim3]);
...
*/
  ...
  TensorTemplate<T>::size(int dimension) const
  {
    ...
    {
      case 1: return m_view_1D->shape()[m_dimension_index[dimension]];
      case 2: return m_view_2D->shape()[m_dimension_index[dimension]];
      case 3: return m_view_3D->shape()[m_dimension_index[dimension]];
      case 4: return m_view_4D->shape()[m_dimension_index[dimension]];
      default: return 0;
    }
  }
  ...
  TensorTemplate<T>::setTensor( const TensorTemplate<T> *src)
  {
    ...
    {
      case 1:
        m_view_1D = new View_1D_Type((*src->getView1D())[ boost::indices[range()] ]);
        break;
      case 2: 
        m_view_2D = new View_2D_Type((*src->getView2D())[ boost::indices[range()][range()] ]);
        break;
      case 3: 
        m_view_3D = new View_3D_Type((*src->getView3D())[ boost::indices[range()][range()][range()] ]);;
        break;
      case 4: 
        m_view_4D = new View_4D_Type((*src->getView4D())[ boost::indices[range()][range()][range()][range()] ]);
        break;
    }
  }
...
//  template <typename T> 
  ...
  TensorTemplate<T>::copy( const TensorTemplate<U> *src)
  {
    ...
    if( this->nDimension() != src->nDimension() )
      raiseFatalError("Tensor::copy(): cannot copy tensors with different number of dimensions.");
   
    for( long d = 0; d < this->nDimension(); d++)
    {
      if(size(d) != src->size(d))
      {
        raiseFatalError("Tensor::copy(): cannot copy tensors of different sizes.");
...
//    setDimensionIndex(src.getDimensionIndex());
    ...
    {
      case 1: 
        m_array_1D = new Tensor_1D_Type(boost::extents[src.size(0)]);
        m_view_1D = new View_1D_Type((*m_array_1D)[ boost::indices[range()] ]);
        break;
      case 2: 
        m_array_2D = new Tensor_2D_Type(boost::extents[src.size(0)][src.size(1)]);
        m_view_2D = new View_2D_Type((*m_array_2D)[ boost::indices[range()][range()] ]);
        break;
      case 3:
        m_array_3D = new Tensor_3D_Type(boost::extents[src.size(0)][src.size(1)][src.size(2)]);
        m_view_3D = new View_3D_Type((*m_array_3D)[ boost::indices[range()][range()][range()] ]);
        break;
      case 4:
        m_array_4D = new Tensor_4D_Type(boost::extents[src.size(0)][src.size(1)][src.size(2)][src.size(3)]);
        m_view_4D = new View_4D_Type((*m_array_4D)[ boost::indices[range()][range()][range()][range()] ]);
        break;
    }
  }
  ...
  TensorTemplate<T>::resize( long size0)
  {
    ...
    else
    {
      ...
      m_array_1D = new Tensor_1D_Type(boost::extents[size0]);
      m_view_1D = new View_1D_Type((*m_array_1D)[ boost::indices[range()] ]);
    }
  }
  ...
  TensorTemplate<T>::resize( long size0, long size1)
  {
    ...
    else
    {
      ...
      m_array_2D = new Tensor_2D_Type(boost::extents[size0][size1]);
      m_view_2D = new View_2D_Type((*m_array_2D)[ boost::indices[range()][range()] ]);
    }
  }
  ...
  TensorTemplate<T>::resize( long size0, long size1, long size2)
  {
    ...
    else
    {
      ...
      m_array_3D = new Tensor_3D_Type(boost::extents[size0][size1][size2]);
      m_view_3D = new View_3D_Type((*m_array_3D)[ boost::indices[range()][range()][range()] ]);
    }
  }
  ...
  TensorTemplate<T>::resize( long size0, long size1, long size2, long size3)
  {
    ...
    else
    {
      ...
      m_array_4D = new Tensor_4D_Type(boost::extents[size0][size1][size2][size3]);
      m_view_4D = new View_4D_Type((*m_array_4D)[ boost::indices[range()][range()][range()][range()] ]);
    }
  }
  ...
  TensorTemplate<T>::set(long dim0, long dim1, char value)
  {
    ...
    (*m_view_2D)[rdim[0]][rdim[1]] = (T)value;
  }
  ...
  TensorTemplate<T>::set(long dim0, long dim1, long dim2, char value)
  {
    ...
    (*m_view_3D)[rdim[0]][rdim[1]][rdim[2]] = (T)value;
  }
  ...
  TensorTemplate<T>::set(long dim0, long dim1, long dim2, long dim3, char value)
  {
    ...
    (*m_view_4D)[rdim[0]][rdim[1]][rdim[2]][rdim[3]] = (T)value;
  }
...
//        std::accumulate(m_array_4D->data(), m_array_4D->data()+m_array_4D->num_elements(), 0);
  ...
  TensorTemplate<T>::get(long dim0, long dim1) const
  {
    long rdim[2];
    indicesCorrectOrder(dim0, dim1, rdim);
    return (*m_view_2D)[rdim[0]][rdim[1]];
  }
  ...
  TensorTemplate<T>::get(long dim0, long dim1, long dim2) const
  {
    long rdim[3];
    indicesCorrectOrder(dim0, dim1, dim2, rdim);
    return (*m_view_3D)[rdim[0]][rdim[1]][rdim[2]];
  }
  ...
  TensorTemplate<T>::get(long dim0, long dim1, long dim2, long dim3) const
  {
    long rdim[4];
    indicesCorrectOrder(dim0, dim1, dim2, dim3, rdim);
    return (*m_view_4D)[rdim[0]][rdim[1]][rdim[2]][rdim[3]];
  }
  ...
  TensorTemplate<T>::narrow( const TensorTemplate<T> *src, int dimension, long firstIndex, long size)
  {
    ...
    {
      case 1:
        m_view_1D = new View_1D_Type((*src->getView1D())[ boost::indices[range(firstIndex,firstIndex+size)]]);
        break;
      case 2:
        switch(m_dimension_index[dimension])
        {
          case 0:
            m_view_2D = new View_2D_Type((*src->getView2D())[ boost::indices[range(firstIndex,firstIndex+size)][range()] ]);
            break;
          case 1:
            m_view_2D = new View_2D_Type((*src->getView2D())[ boost::indices[range()][range(firstIndex,firstIndex+size)] ]);
            break;
        }
        break;
      case 3: 
        ...
        {
          case 0:
            m_view_3D = new View_3D_Type((*src->getView3D())[ boost::indices[range(firstIndex,firstIndex+size)][range()][range()] ]);
            break;
          case 1:
            m_view_3D = new View_3D_Type((*src->getView3D())[ boost::indices[range()][range(firstIndex,firstIndex+size)][range()] ]);
            break;
          case 2:
            m_view_3D = new View_3D_Type((*src->getView3D())[ boost::indices[range()][range()][range(firstIndex,firstIndex+size)] ]);
            break;
        }
        break;
      case 4: 
        ...
        {
          case 0:
            m_view_4D = new View_4D_Type((*src->getView4D())[ boost::indices[range(firstIndex,firstIndex+size)][range()][range()][range()] ]);
            break;
          case 1:
            m_view_4D = new View_4D_Type((*src->getView4D())[ boost::indices[range()][range(firstIndex,firstIndex+size)][range()][range()] ]);
            break;
          case 2:
            m_view_4D = new View_4D_Type((*src->getView4D())[ boost::indices[range()][range()][range(firstIndex,firstIndex+size)][range()] ]);
            break;
          case 3:
            m_view_4D = new View_4D_Type((*src->getView4D())[ boost::indices[range()][range()][range()][range(firstIndex,firstIndex+size)] ]);
            break;
        }
        break;
    } 
  ...
  TensorTemplate<T>::select( const TensorTemplate<T> *src, int dimension, long sliceIndex)
  {
    ...
    switch(m_n_dimensions) 
    {
      ...
      case 1:
        ...
        {
          case 0:
            m_view_1D = new View_1D_Type((*src->getView2D())[ boost::indices[sliceIndex][range()]]);
            break;
          case 1:
            m_view_1D = new View_1D_Type((*src->getView2D())[ boost::indices[range()][sliceIndex]]);
            break;
          default:
            break;
        }
      ...
      case 2:
        ...
        {
          case 0:
            m_view_2D = new View_2D_Type((*src->getView3D())[ boost::indices[sliceIndex][range()][range()]]);
            break;
          case 1:
            m_view_2D = new View_2D_Type((*src->getView3D())[ boost::indices[range()][sliceIndex][range()]]);
            break;
          case 2:
            m_view_2D = new View_2D_Type((*src->getView3D())[ boost::indices[range()][range()][sliceIndex]]);
            break;
          default:
            break;
        }
      ...
      case 3:
        ...
        {
          case 0:
            m_view_3D = new View_3D_Type((*src->getView4D())[ boost::indices[sliceIndex][range()][range()][range()]]);
            break;
          case 1:
            m_view_3D = new View_3D_Type((*src->getView4D())[ boost::indices[range()][sliceIndex][range()][range()]]);
            break;
          case 2:
            m_view_3D = new View_3D_Type((*src->getView4D())[ boost::indices[range()][range()][sliceIndex][range()]]);
            break;
          case 3:
            m_view_3D = new View_3D_Type((*src->getView4D())[ boost::indices[range()][range()][range()][sliceIndex]]);
            break;
          default:
            break;
        }
        ...
        for(long i = 0; i<size(0); i++)
          for(long j = 0; j<size(1); j++)
            for(long k = 0; k<size(2); k++)
            {
              ...
              (*m_view_3D)[rdim[0]][rdim[1]][rdim[2]] = val;
            }
          ...
          for(long j = 0; j<size(1); j++)
            for(long k = 0; k<size(2); k++)
              for(long l = 0; l<size(3); l++)
              {
                ...
                (*m_view_4D)[rdim[0]][rdim[1]][rdim[2]][rdim[3]] = val;
              }
