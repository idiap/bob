...
namespace Torch { namespace python {
  ...
  template<typename T, int N> struct array_binder {
    ...
    public:
      ...
      /**
       * This will load mathematical functions that operate on blitz arrays/opt/local/include/blitz/array/resize.cc:587.
       */
...
#define declare_bool_arrays(T,NAME) void BOOST_JOIN(bind_core_array_,NAME)() { \
  namespace tp = Torch::python; \
  tp::array_binder<T,1> a1(BOOST_STRINGIZE(NAME)); \
  a1.load_bool_methods(); \
  a1.load_bool_int_uint_methods(); \
  a1.load_non_complex_methods(); \
  tp::array_binder<T,2> a2(BOOST_STRINGIZE(NAME)); \
  a2.load_bool_methods(); \
  a2.load_bool_int_uint_methods(); \
  a2.load_non_complex_methods(); \
  tp::array_binder<T,3> a3(BOOST_STRINGIZE(NAME)); \
  a3.load_bool_methods(); \
  a3.load_bool_int_uint_methods(); \
  a3.load_non_complex_methods(); \
  tp::array_binder<T,4> a4(BOOST_STRINGIZE(NAME)); \
  a4.load_bool_methods(); \
  a4.load_bool_int_uint_methods(); \
  a4.load_non_complex_methods(); \
}

#define declare_integer_arrays(T,NAME) void BOOST_JOIN(bind_core_array_,NAME)() { \
  namespace tp = Torch::python; \
  tp::array_binder<T,1> a1(BOOST_STRINGIZE(NAME)); \
  a1.load_int_methods(); \
  a1.load_bool_int_uint_methods(); \
  a1.load_non_complex_methods(); \
  a1.load_int_float_complex_methods(); \
  tp::array_binder<T,2> a2(BOOST_STRINGIZE(NAME)); \
  a2.load_int_methods(); \
  a2.load_bool_int_uint_methods(); \
  a2.load_non_complex_methods(); \
  a2.load_int_float_complex_methods(); \
  tp::array_binder<T,3> a3(BOOST_STRINGIZE(NAME)); \
  a3.load_int_methods(); \
  a3.load_bool_int_uint_methods(); \
  a3.load_non_complex_methods(); \
  a3.load_int_float_complex_methods(); \
  tp::array_binder<T,4> a4(BOOST_STRINGIZE(NAME)); \
  a4.load_int_methods(); \
  a4.load_bool_int_uint_methods(); \
  a4.load_non_complex_methods(); \
  a4.load_int_float_complex_methods(); \
}

#define declare_unsigned_arrays(T,NAME) void BOOST_JOIN(bind_core_array_,NAME)() { \
  namespace tp = Torch::python; \
  tp::array_binder<T,1> a1(BOOST_STRINGIZE(NAME)); \
  a1.load_uint_methods(); \
  a1.load_bool_int_uint_methods(); \
  a1.load_non_complex_methods(); \
  tp::array_binder<T,2> a2(BOOST_STRINGIZE(NAME)); \
  a2.load_uint_methods(); \
  a2.load_bool_int_uint_methods(); \
  a2.load_non_complex_methods(); \
  tp::array_binder<T,3> a3(BOOST_STRINGIZE(NAME)); \
  a3.load_uint_methods(); \
  a3.load_bool_int_uint_methods(); \
  a3.load_non_complex_methods(); \
  tp::array_binder<T,4> a4(BOOST_STRINGIZE(NAME)); \
  a4.load_uint_methods(); \
  a4.load_bool_int_uint_methods(); \
  a4.load_non_complex_methods(); \
}

#define declare_float_arrays(T,NAME) void BOOST_JOIN(bind_core_array_,NAME)() { \
  namespace tp = Torch::python; \
  tp::array_binder<T,1> a1(BOOST_STRINGIZE(NAME)); \
  a1.load_float_methods(); \
  a1.load_non_complex_methods(); \
  a1.load_int_float_complex_methods(); \
  a1.load_float_complex_methods(); \
  tp::array_binder<T,2> a2(BOOST_STRINGIZE(NAME)); \
  a2.load_float_methods(); \
  a2.load_non_complex_methods(); \
  a2.load_int_float_complex_methods(); \
  a2.load_float_complex_methods(); \
  tp::array_binder<T,3> a3(BOOST_STRINGIZE(NAME)); \
  a3.load_float_methods(); \
  a3.load_non_complex_methods(); \
  a3.load_int_float_complex_methods(); \
  a3.load_float_complex_methods(); \
  tp::array_binder<T,4> a4(BOOST_STRINGIZE(NAME)); \
  a4.load_float_methods(); \
  a4.load_non_complex_methods(); \
  a4.load_int_float_complex_methods(); \
  a4.load_float_complex_methods(); \
}

#define declare_complex_arrays(T,NAME) void BOOST_JOIN(bind_core_array_,NAME)() { \
  namespace tp = Torch::python; \
  tp::array_binder<T,1> a1(BOOST_STRINGIZE(NAME)); \
  a1.load_complex_methods(); \
  a1.load_int_float_complex_methods(); \
  a1.load_float_complex_methods(); \
  tp::array_binder<T,2> a2(BOOST_STRINGIZE(NAME)); \
  a2.load_complex_methods(); \
  a2.load_int_float_complex_methods(); \
  a2.load_float_complex_methods(); \
  tp::array_binder<T,3> a3(BOOST_STRINGIZE(NAME)); \
  a3.load_complex_methods(); \
  a3.load_int_float_complex_methods(); \
  a3.load_float_complex_methods(); \
  tp::array_binder<T,4> a4(BOOST_STRINGIZE(NAME)); \
  a4.load_complex_methods(); \
  a4.load_int_float_complex_methods(); \
  a4.load_float_complex_methods(); \
}
