/**
 * @file cxx/ip/src/ipHaarLienhart.cc
...
///////////////////////////////////////////////////////////////////////////////////////////
    bool ipHaarLienhart::setRec(int Rec_,double weight_, int y_, int x_, int h_, int w_)
    {
        ...
        if (Rec_>m_noRecs-1)
        {
            bob::error("ipHaarLienhart::setRec() The rec parameters exceeds the number of Recs set");
            return false;
        }
...
////////////////////////////////////////////////////////////////////////////////////////
    bool ipHaarLienhart::checkInput(const Tensor& input) const
    {
        ...
        {
            bob::error("ipHaarLienhart::checkInput() input should be 2D or 3D");
            return false;
        }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    bool ipHaarLienhart::loadFile(File& file)
    {
        ...
        {
            bob::message("ipHaarLienhart::load - failed to read <Width> field!\n");
            return false;
        }
        ...
        {
            bob::message("ipHaarLienhart::load - failed to read <Height> field!\n");
            return false;
        }
        ...
        {
            bob::message("ipHaarLienhart::load - failed to read <NoRecs> field!\n");
            return false;
        }
        ...
        {
            bob::message("ipHaarLienhart::load - failed to read <parameters> field!\n");
            return false;
        }
        ...
        {
            bob::message("ipHaarLienhart::load - failed to read <weight> field!\n");
            return false;
        }
...
//////////////////////////////////////////////////////////////////////////////////////
    bool ipHaarLienhart::saveFile(File& file) const
    {
        ...
        {
            bob::message("ipHaarLienhart::save - failed to write <CoreID> field!\n");
            return false;
        }
        ...
        {
            bob::message("ipHaarLienhart::save - failed to write <Width> field!\n");
            return false;
        }

        if (file.taggedWrite(&m_height, 1, "Height") != 1)
        {
            bob::message("ipHaarLienhart::save - failed to write <height> field!\n");
            return false;
        }

        if (file.taggedWrite(&m_noRecs, 1, "NoRecs") != 1)
        {
            bob::message("ipHaarLienhart::save - failed to write <NoRecs> field!\n");
            return false;
        }
        ...
        {
            bob::message("ipHaarLienhart::save - failed to write <parameters> field!\n");
            return false;
        }

        if (file.taggedWrite(m_weight, m_noRecs, "weight") != m_noRecs)
        {
            bob::message("ipHaarLienhart::save - failed to write <weight> field!\n");
            return false;
        }
