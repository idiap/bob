...
public:
  ...
  virtual void initialization(bob::machine::KMeansMachine& kMeansMachine, const bob::io::Arrayset& sampler);
  ...
  virtual double eStep(bob::machine::KMeansMachine& kmeans, const bob::io::Arrayset& data);
  
  virtual void mStep(bob::machine::KMeansMachine& kmeans, const bob::io::Arrayset&);
