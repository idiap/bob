...
Torch::trainer::ML_GMMTrainer::ML_GMMTrainer() : GMMTrainer() {
...
void Torch::trainer::ML_GMMTrainer::mStep(Torch::machine::GMMMachine& gmm, const Sampler< Torch::machine::FrameSample >& data){
