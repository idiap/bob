...
namespace Torch { namespace machine {
  ...
  class LinearMachine {
    ...
    public: //api
      ...
      /**
       * Builds a new machine with a set of weights.
       */
       ...
       */
      inline size_t inputSize () const { return m_weight.extent(1); }

      /**
       * Returns the number of outputs generated by this machine
       */
      inline size_t outputSize () const { return m_weight.extent(0); }
      ...
      /**
       * Sets the current weights. We will check that the number of outputs
