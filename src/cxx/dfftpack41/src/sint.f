C     _SUBROUTINE SINT(N,X,WSAVE)
C
C     _SUBROUTINE SINT COMPUTES THE DISCRETE FOURIER SINE TRANSFORM
...
C     X BY 2*(N+1).
C
C     THE ARRAY WSAVE WHICH IS USED BY _SUBROUTINE SINT MUST BE
C     INITIALIZED BY CALLING _SUBROUTINE SINTI(N,WSAVE).
C
C     INPUT PARAMETERS
C
...
C             IN THE _PROGRAM THAT CALLS SINT. THE WSAVE ARRAY MUST BE
C             INITIALIZED BY CALLING _SUBROUTINE SINTI(N,WSAVE) AND A
