C     _SUBROUTINE COST(N,X,WSAVE)
C
C     _SUBROUTINE COST COMPUTES THE DISCRETE FOURIER COSINE TRANSFORM
...
C
C     THE ARRAY WSAVE WHICH IS USED BY _SUBROUTINE COST MUST BE
C     INITIALIZED BY CALLING _SUBROUTINE COSTI(N,WSAVE).
C
C     INPUT PARAMETERS
C
...
C             IN THE _PROGRAM THAT CALLS COST. THE WSAVE ARRAY MUST BE
C             INITIALIZED BY CALLING _SUBROUTINE COSTI(N,WSAVE) AND A
