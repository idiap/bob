C     _SUBROUTINE COSQF(N,X,WSAVE)
C
C     _SUBROUTINE COSQF COMPUTES THE FAST FOURIER TRANSFORM OF QUARTER
...
C     BY 4*N.
C
C     THE ARRAY WSAVE WHICH IS USED BY _SUBROUTINE COSQF MUST BE
...
C             IN THE _PROGRAM THAT CALLS COSQF. THE WSAVE ARRAY MUST
C             BE INITIALIZED BY CALLING _SUBROUTINE COSQI(N,WSAVE) AND
