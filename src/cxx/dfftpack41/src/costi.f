C     _SUBROUTINE COSTI(N,WSAVE)
C
C     _SUBROUTINE COSTI INITIALIZES THE ARRAY WSAVE WHICH IS USED IN
C     _SUBROUTINE COST. THE PRIME FACTORIZATION OF N TOGETHER WITH
