C     _SUBROUTINE COSQB(N,X,WSAVE)
C
C     _SUBROUTINE COSQB COMPUTES THE FAST FOURIER TRANSFORM OF QUARTER
...
C     BY 4*N.
C
C     THE ARRAY WSAVE WHICH IS USED BY _SUBROUTINE COSQB MUST BE
C     INITIALIZED BY CALLING _SUBROUTINE COSQI(N,WSAVE).
C
C
C     INPUT PARAMETERS
C
...
C
C     WSAVE   A WORK ARRAY THAT MUST BE DIMENSIONED AT LEAST 3*N+15 IN
C             THE _PROGRAM THAT CALLS COSQB. THE WSAVE ARRAY MUST BE
C             INITIALIZED BY CALLING _SUBROUTINE COSQI(N,WSAVE) AND A
