C     _SUBROUTINE EZFFTF(N,R,AZERO,A,B,WSAVE)
C
C     _SUBROUTINE EZFFTF COMPUTES THE FOURIER COEFFICIENTS OF A REAL
...
C             IN THE _PROGRAM THAT CALLS EZFFTF. THE WSAVE ARRAY MUST
