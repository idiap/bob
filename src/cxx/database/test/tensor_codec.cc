/**
 * @file src/cxx/database/test/tensor_codec.cc
...
BOOST_AUTO_TEST_CASE( tensor_2d_read_T5alpha )
{
  ...
  // Prepare database Array from Tensor file saved with Torch5 alpha
  Torch::database::Array db_b(testdata_path.string());
