/**
 * @file database/BinaryArraysetCodec.h
...
#ifndef TORCH_DATABASE_BINARYARRAYSETCODEC_H 
#define TORCH_DATABASE_BINARYARRAYSETCODEC_H
...
namespace Torch { namespace database {
  ...
  /**
   * BinaryArraysetCodecs can read and write single arrays into a
   * Torch-compatible binary file.
   */
  class BinaryArraysetCodec : public ArraysetCodec {

    public:

      BinaryArraysetCodec();

      virtual ~BinaryArraysetCodec();
...
#endif /* TORCH_DATABASE_BINARYARRAYSETCODEC_H */
