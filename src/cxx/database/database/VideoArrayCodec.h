...
#ifndef TORCH5SPRO_DATABASE_VIDEO_ARRAYCODEC_H 
#define TORCH5SPRO_DATABASE_VIDEO_ARRAYCODEC_H
...
namespace Torch { namespace database {
  ...
  class VideoArrayCodec : public ArrayCodec {
    ...
    public:
       ...
       * need access to these variables then please use db::VideoReader
       * directly.
       */
       ...
       *
       * If that is not what you want, then please use db::VideoWriter
       * directly.
       */
...
#endif /* TORCH5SPRO_DATABASE_VIDEO_ARRAYCODEC_H */
