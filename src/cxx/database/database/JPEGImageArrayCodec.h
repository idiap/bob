 ...
 *
 * @brief Converts data from the JPEG image format into Torch5spro.
 */

#ifndef TORCH5SPRO_DATABASE_JPEGIMAGE_ARRAYCODEC_H 
#define TORCH5SPRO_DATABASE_JPEGIMAGE_ARRAYCODEC_H 1
...
namespace Torch { namespace database {
  ...
  /**
   * Reads and writes single Arrays to JPEG image files
   */
  class JPEGImageArrayCodec : public ArrayCodec {

    public:

      JPEGImageArrayCodec();

      virtual ~JPEGImageArrayCodec();
...
#endif /* TORCH5SPRO_DATABASE_JPEGIMAGE_ARRAYCODEC_H */
