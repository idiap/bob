/**
 * @file database/TensorArrayCodec.h
...
#ifndef TORCH_DATABASE_TENSORARRAYCODEC_H 
#define TORCH_DATABASE_TENSORARRAYCODEC_H
...
namespace Torch { namespace database {
  ...
  /**
   * TensorArrayCodecs can read and write single arrays into a Torch-compatible
   * tensor file.
   */
  class TensorArrayCodec : public ArrayCodec {

    public:

      TensorArrayCodec();

      virtual ~TensorArrayCodec();
...
#endif /* TORCH_DATABASE_TENSORARRAYCODEC_H */
