...
#ifndef TORCH_DATABASE_TORCH3VSIONARRAYCODEC_H 
#define TORCH_DATABASE_TORCH3VSIONARRAYCODEC_H
...
namespace Torch { namespace database {
  ...
  class T3BinaryArrayCodec : public ArrayCodec {
    ...
    public:
      ...
      T3BinaryArrayCodec(bool save_in_float32=true);
...
#endif /* TORCH_DATABASE_TORCH3VSIONARRAYCODEC_H */
