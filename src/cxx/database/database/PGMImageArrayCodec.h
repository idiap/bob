 ...
 *
 * @brief Converts data from the Portable Graymap (PGM) P5 image format into
 * Torch5spro.
 */

#ifndef TORCH5SPRO_DATABASE_PGMIMAGE_ARRAYCODEC_H 
#define TORCH5SPRO_DATABASE_PGMIMAGE_ARRAYCODEC_H 1
...
namespace Torch { namespace database {
  ...
  /**
   * Reads and writes single Arrays to PGM P5 image files
   */
  class PGMImageArrayCodec : public ArrayCodec {

    public:

      PGMImageArrayCodec();

      virtual ~PGMImageArrayCodec();
