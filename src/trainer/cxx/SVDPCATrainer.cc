  ...
  blitz::Array<double,1>& eigen_values, const blitz::Array<double,2>& ar)
{
   ...
   */
  const int n_sigma_1 = (n_sigma == (int)n_features)? n_features : n_samples;
  blitz::Array<double,2> U(n_features, n_sigma_1);
  blitz::Array<double,1> sigma(n_sigma_1);
  ...
  blitz::Range up_to_n_sigma(0, n_sigma-1);
  machine.setWeights(U(a,up_to_n_sigma));
