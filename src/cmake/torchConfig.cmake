...
# This macro helps users to build torch-based executables with more
# sophisticated dependence schemes allowing external linkage for example.
macro(torch_executable name sources dependencies externals)
  include_directories(${torch_INCLUDE_DIRS})
  link_directories(${torch_LIBRARY_DIRS})
  add_executable(${name} "${sources}")
  # Links dependencies
  ...
  if(NOT ("${externals}" STREQUAL ""))
    foreach(ext ${externals})
      target_link_libraries(${name} ${ext})
    endforeach(ext ${externals})
  endif(NOT ("${externals}" STREQUAL ""))
endmacro(torch_executable name sources dependencies externals)
