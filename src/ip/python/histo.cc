...
static void inner_histogram_equalization2(tp::const_ndarray src, tp::ndarray dst){
...
template <typename T>
static void inner_histogram_equalization(tp::const_ndarray src, tp::ndarray dst){
...
static void histogram_equalization(tp::const_ndarray src, tp::ndarray dst){
...
static tp::ndarray histogram_equalization_single(tp::const_ndarray src){
  tp::ndarray dst(src.type());
