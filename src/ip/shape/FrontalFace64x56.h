#ifndef FRONTAL_FACE_64x56_INC
#define FRONTAL_FACE_64x56_INC

#include "FaceModel.h"

namespace Torch {

/** This class is designed to extract faces of size 64x56 given eye center coordinates
    ...
    @since 1.0
*/
class FrontalFace64x56 : public FaceModel
{
   	//
	double D_EYES;
