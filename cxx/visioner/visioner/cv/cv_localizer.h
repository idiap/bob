...
namespace bob { namespace visioner {
  ...
  /////////////////////////////////////////////////////////////////////////////////////////
  // Keypoint localizer initialized with either ground truth or valid object detections:
  //	::locate()	-> predict the location of the keypoints
  //	::evaluate()	-> computes the error histogram for each keypoint and cumulated
  /////////////////////////////////////////////////////////////////////////////////////////
  ...
  class CVLocalizer
  {
    public:
      ...
      bool locate(	const CVDetector& detector, const rect_t& reg, points_t& points) const;
    ...
    private:
      ...
      //      - one shot (only the detection)
      //              vs. multiple shots (collect predictions nearby the detection)
